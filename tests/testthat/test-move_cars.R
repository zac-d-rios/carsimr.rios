...
test_that("cars stay on the grid", {
  grid_check_move <- initialize_grid(
    rho = 0.5,
    dims = c(9, 10),
    prob_blue = 0.5
  )
  ...
  post_move <- move_cars(grid_check_move, 12)
